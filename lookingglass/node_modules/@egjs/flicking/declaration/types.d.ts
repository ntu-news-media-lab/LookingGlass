import Flicking from "@egjs/flicking/declaration/Flicking";
import Viewport from "@egjs/flicking/declaration/components/Viewport";
import StateMachine from "@egjs/flicking/declaration/components/StateMachine";
import Panel from "@egjs/flicking/declaration/components/Panel";
import Component from "@egjs/flicking/declaration/node_modules/@egjs/component";
import State from "@egjs/flicking/declaration/states/State";
import { DiffResult } from "@egjs/flicking/declaration/node_modules/@egjs/list-differ";
...
export declare type FlickingEvent = {
    type: string;
    index: number;
...
export declare type NeedPanelEvent = {
    type: string;
    index: number;
    panel: FlickingPanel | null;
    progress: number;
...
export declare type VisibleChangeEvent = {
    type: string;
    range: {
        min: number;
        max: number;
...
export declare type ContentErrorEvent = {
    type: string;
    element: HTMLElement;
};
...
export declare type ExcludeKeys = keyof Component | "replace" | "append" | "remove" | "prepend" | "beforeSync" | "sync" | "getCloneCount" | "getRenderingIndexes" | "getLastIndex" | "setLastIndex" | "addPlugins" | "removePlugins";
...
export declare type BeforeSyncResult = Pick<DiffResult<any>, "added" | "changed" | "maintained" | "removed">;
export declare type SyncResult = Pick<DiffResult<HTMLElement>, "added" | "changed" | "maintained" | "removed" | "list">;
