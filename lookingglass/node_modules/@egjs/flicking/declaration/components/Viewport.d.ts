...
import PanelManager from "@egjs/flicking/declaration/components/PanelManager";
import StateMachine from "@egjs/flicking/declaration/components/StateMachine";
import MoveType from "@egjs/flicking/declaration/moves/MoveType";
import { FlickingOptions, FlickingPanel, FlickingStatus, ElementLike, EventType, TriggerCallback, Plugin, DestroyOption, BoundingBox } from "@egjs/flicking/declaration/types";
export default class Viewport {
    ...
    addVisiblePanel(panel: Panel): void;
    enable(): void;
    disable(): void;
    ...
    appendUncachedPanelElements(panels: Panel[]): void;
    private updateClonePanels;
    private getVisibleIndexOf;
    private build;
    private setElements;
    ...
    private checkNeedPanel;
    private triggerNeedPanel;
    private updateVisiblePanels;
    private checkVisiblePanelChange;
